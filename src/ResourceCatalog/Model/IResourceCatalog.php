...
interface IResourceCatalog extends IResourceCatalogTypeName, IResourceCatalogTypeIdentify, IResourceCatalogTypeEnName, IResourceCatalogTypeDoublePublicity, IResourceCatalogTypeRedBlackList, IResourceCatalogIsConfirm
{
    ...
    const USERGROUP_TYPE_RELATIONSHIP = array(
        ...
        IUserGroup::ID['FGW'] => array(self::TYPE['ZZZS'],self::TYPE['ZYRY'],self::TYPE['ZLXX'],self::TYPE['SJKZR'],self::TYPE['SFAJXX'],self::TYPE['QYNB'],self::TYPE['KZQYXX'],self::TYPE['KGGX'],self::TYPE['GSXX'],self::TYPE['GDXX'],self::TYPE['DWTZXX'],self::TYPE['CPWSXX'],self::TYPE['BGJLXX'],
            self::TYPE['JGJCDXZJL'],
            self::TYPE['SJJXMXX'],
